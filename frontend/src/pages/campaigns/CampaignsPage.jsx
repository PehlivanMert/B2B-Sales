...
import { Loader2, Mail, Calendar, Users, FileText } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      {campaigns.length === 0 ? (
        <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center shadow-sm">
          ...
          <h3 className="text-lg font-semibold text-slate-700">Henüz kampanya yok</h3>
          <p className="text-slate-500 mt-1">Acenteler sayfasından filtrelenen listelere toplu e-posta gönderebilirsiniz.</p>
        </div>
      ) : (
        <div className="grid gap-4">
          {campaigns.map(camp => (
            <div key={camp.id} className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm hover:border-blue-200 transition-colors">
